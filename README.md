...
- flux архитектура - https://facebookarchive.github.io/flux/docs/in-depth-overview/
...
- добавить ErrorBoundary в проект
- унести корзину в модалку: в шапке добавляется кнопка корзины и по клику открываем модалку
